const ptBR = {
  ...
  roles: {
    ...
    petEditor: {
      label: 'Editor de Pets',
      description: 'Acesso de edição aos Pets',
    },
    petViewer: {
      label: 'Visualizador de Pets',
      description: 'Acesso de visualização aos Pets',
    },
    bookingEditor: {
      label: 'Editor de Bookings',
      description: 'Acesso de edição aos Bookings',
    },
    bookingViewer: {
      label: 'Visualizador de Bookings',
      description: 'Acesso de visualização aos Bookings',
    },
  },
